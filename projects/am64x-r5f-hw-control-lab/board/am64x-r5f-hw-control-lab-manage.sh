...
TEST_FW_DIR="/usr/lib/firmware/ti-bringup/am64x-r5f-hw-control-lab"
TEST_FW_PATH="${TEST_FW_DIR}/${FW_NAME}"
A53_APP="/usr/local/bin/r5ctl"

STATE_DIR="/var/lib/ti-bringup/am64x-r5f-hw-control-lab"
...
log() {
    printf '[am64x-r5f-hw-control-lab] %s\n' "$*"
}
...
case "$ACTION" in
    ...
    *)
        ...
        log "examples: $0 test ping | $0 test status | $0 test gpio set 1"
        exit 1
        ;;
esac
