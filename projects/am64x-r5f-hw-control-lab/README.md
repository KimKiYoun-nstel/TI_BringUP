...
- [docs/resource-ownership.md](docs/resource-ownership.md): Phase 1 resource ownership과 금지 대상 정리
- [docs/test-procedure.md](docs/test-procedure.md): 외부 LED/멀티미터 기준 실측 절차
- [docs/wiring-mcu-connector.md](docs/wiring-mcu-connector.md): MCU connector 후보 pin 배선 가이드
