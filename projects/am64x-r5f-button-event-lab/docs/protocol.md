...
| A53 CLI | R5F command | Expected response |
|---|---|---|
| `r5ctl ping` | `PING` | `OK PONG` |
| `r5ctl status` | `STATUS` | `OK STATUS ...` |
| `r5ctl button status` | `BUTTON_STATUS` | `OK BUTTON_STATUS ...` |
| `r5ctl button wait [timeout_ms]` | `BUTTON_WAIT <timeout_ms>` | `BUTTON_EVENT ...` or timeout text |
| `r5ctl button monitor` | `BUTTON_MONITOR` | subscribe ack, then events |
| `r5ctl event monitor` | `EVENT_MONITOR` | subscribe ack, then events |
